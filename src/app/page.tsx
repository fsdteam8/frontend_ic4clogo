...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative z-0">
      ...
      {/* Second  Content */}
      <section className="relative w-full bg-gradient-to-b from-[#2D5E69] to-[#D7F8FF] overflow-visible rounded-t-[15px] md:rounded-t-[40px] h-[1100px] sm:h-[1200px] md:h-[870px] lg:h-[850px] z-[-10] mt-[105px] md:mt-[130px] lg:mt[170px]">
